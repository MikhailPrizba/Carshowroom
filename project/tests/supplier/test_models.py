...
class TestSupplierModel:
    def test_supplier_creation(self):
        supplier = Supplier.objects.create_instance(
            username="supplier",
...
class TestSupplierCarModel:
    ...
    def test_supplier_car_update(self):
        G(SupplierCar)
        supplier_car = SupplierCar.objects.update_instance(
            id=1, model="Civic", price=22000.00, count=1
        )
...
class TestSupplierOfferModel:
    def test_supplier_offer_creation(self):
        ...
        supplier_offer = SupplierOffer.objects.create_instance(
            supplier=supplier, dealership=dealership, max_price=30000.00, paid=False
        )
    ...
    def test_supplier_offer_update(self):
        G(SupplierOffer)
        supplier_offer = SupplierOffer.objects.update_instance(
            id=1, max_price=28000.00, paid=True
        )
